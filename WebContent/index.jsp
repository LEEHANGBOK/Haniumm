...
<% String saveDir = "C:/Users/tjsal/upload"; //절대경로 입력 시 해당 디렉토리에 있는 파일들을 페이지 상에 출력, 클릭 시 다운로드 가능
            ...
            <div class="box-header with-border">
              <h3 class="box-title">File List</h3>       
              	 <form action="fileupload.jsp" method="post"  enctype="multipart/form-data">
					...
					<button id="newFile" onclick="check()" class="btn btn-block btn-default btn-sm" style = "WIDTH: 70pt; HEIGHT: 23pt" cursor:pointer;">분할 업로드</button>	
				 	</div>
				 	<script>
				 	function check(){
                 ...
                 <table class="table no-margin">
                  ...
                  %>
                    <tr>                  
                        ...
                        out.write("<a href=\"" + request.getContextPath() + "/FileDownload?filename=" + java.net.URLEncoder.encode(fileName, "UTF-8") + "\">" + fileName.substring(0,j) + "</a><br>");
                        %></td>                        
                        <td><%
                        out.println(fileName.substring(j+1));%></td>                  
                           <td><%="3MB" %></td>
                        <td>
                        <%="August 23th, 2017" %>
                        </td>
